  ...
  <div class="login">
    <div class="login-panel" v-show="showLogin">
      <el-form :model="loginForm" class="login-form" :rules="loginFormRules" ref="loginForm">
        ...
        <el-form-item prop="email">
          <el-input v-model="loginForm.email" prefix-icon="fa fa-envelope" placeholder="邮箱" clearable></el-input>
        </el-form-item>
        <el-form-item prop="password">
          <el-input v-model="loginForm.password" prefix-icon="fa fa-lock" placeholder="密码" :type="loginPasswordType">
            <i slot="suffix"
               :class="{'fa': true, 'fa-eye': loginPasswordType=='password','fa-eye-slash': loginPasswordType!='password'}"
        ...
        <el-form-item>
          ...
          <div style="float: right;color: white">还没有账号，
            <el-button type="text" @click="showLogin=false">立即注册</el-button>
          </div>
        </el-form-item>
      </el-form>
    </div>
    <div class="register-panel" v-show="!showLogin">
      <el-form :model="registerForm" class="login-form" :rules="registerFormRules" ref="registerForm">
        ...
        <el-form-item prop="email">
          <el-input v-model="registerForm.email" prefix-icon="fa fa-envelope" placeholder="邮箱" type="email"
                    clearable></el-input>
        </el-form-item>
        <el-form-item prop="password">
          <el-input v-model="registerForm.password" prefix-icon="fa fa-lock" placeholder="密码"
                    :type="registerPasswordType">
            <i slot="suffix"
               :class="{'fa': true, 'fa-eye': loginPasswordType=='password','fa-eye-slash': registerPasswordType!='password'}"
        ...
        <el-form-item>
          ...
          <div style="float: right;color: white">已有账号，
            <el-button type="text" @click="showLogin=true">立即登录</el-button>
          </div>
        </el-form-item>
      </el-form>
    </div>
